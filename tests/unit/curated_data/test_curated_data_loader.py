...
class TestCuratedDataCopier:
    ...
    def test_run(
        ...
        with patch(
            "daap_api.services.curated_data.curated_data_loader.start_query_execution_and_wait"
        ) as mock_query:
            with patch(
                "daap_api.services.curated_data.curated_data_loader.refresh_table_partitions"
            ) as mock_refresh:
